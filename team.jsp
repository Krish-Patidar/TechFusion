...
<nav class="navbar navbar-expand-lg navbar-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="container">
        <form id="addTeamForm" class="form" method="post" enctype="multipart/form-data">
            <p class="title">Form a Team</p>
              <div class="form-group">
                <label for="tid">
                                            <span class="color">Team Id</span>
                                            
                
                <input type="text" class="form-control input" id="itd" name="tid" required>
                </label>
            </div>
            <div class="form-group">
                <label for="name">
                                            <span class="color">Team Name</span>
             ...
             <div class="form-group">
                <label for="namelead">
                                            <span class="color">Team Lead Name</span>
                                            
                
                <input type="text" class="form-control input" id="namelead" name="namelead" required>
                </label>
            </div>
            <div class="form-group">
                <label for="email">
                                        <span class="color">Team Email</span>
            ...
            <div class="form-group">
                <label for="task">
                                      <span class="color">Team Task</span>
              
                <input type=text class="form-control input" id="task" name="task" required>
                
                </label>
            </div>
               <div class="form-group">
                <label for="assign">
                                        <span class="color">Task Assign Date</span>
                
                <input type="date" class="form-control input" id="assign" name="assign" required>
                
                </label>
            </div>
            <div class="form-group">
                <label for="deadline">
                                        <span class="color">Task Deadline</span>
                
                <input type="date" class="form-control input" id="deadline" name="deadline" required>
                
                </label>
            </div>
            <div class="form-group">
                <label for="size">
                                        <span class="color">Team Size</span>
                
                <input type="number" class="form-control input" id="size" name="size" required>
                
                </label>
            </div>
            <div class="form-group">
                <label for="department">
                                        <span class="color">Team Department</span>
            ...
            <div class="form-group">
                <label for="image">
                                        <span class="color">Upload Team Lead Image</span>
                
                <input type="file" class="form-control input" id="image" name="image" required>
                
                </label>
            </div>
            <button type="submit" class="btn btn-primary submit">Form Team</button>
        </form>
